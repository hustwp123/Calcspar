...
class TokenLimiter {
 ...
 private:
  ...
  const uint64_t limits[Env::IOSource::IO_SRC_DEFAULT]={900 * 1000, 800 * 1000, 500 * 1000, 0};
  //
 ...
 public:
  ...
  static void RequestDefaultToken(Env::IOSource io_src, IOType io_type,int32_t n = 1);
